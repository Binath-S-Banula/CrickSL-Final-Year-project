...
const TECH = ['FastAPI', 'PostgreSQL', 'React', 'scikit-learn', 'JWT Auth', 'CI/CD']
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <p className="footer-brand-desc">
              ...
              Built on 4,991 matches and 1.1 million ball-by-ball delivery records
              using machine learning and statistical analytics.
            </p>
