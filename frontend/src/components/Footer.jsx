      ...
      <div className="footer-inner">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-info-section" style={{ marginTop: '1rem' }}>
              <div className="footer-info-sub">Links</div>
              <a
                href="https://github.com/Binath-S-Banula/CrickSL-Final-Year-project"
                target="_blank" rel="noreferrer"
                className="footer-link footer-link-external">
                <span className="footer-arrow">→</span>GitHub Repository
              </a>
              <a
                href="http://localhost:8000/docs"
                target="_blank" rel="noreferrer"
                className="footer-link footer-link-external">
                <span className="footer-arrow">→</span>API Documentation
              </a>
            </div>
          </div>
