...
export default function PlayingXI() {
  ...
  const recommend = async () => {
    if (!venueName || !opponent) {
      setError("Please select venue and opponent");
      return;
    }
    const filled = oppXI.filter((p) => p.trim());
    if (filled.length < 11) {
      setError("Please enter all 11 opponent players");
      return;
    }
    setLoading(true);
    setError("");
    setResults(null);
    try {
      const r = await getXIRecommendation({
  ...
  return (
    <div className="page fade-in">
      ...
      <p className="page-subtitle">
        MCDA-based player selection using venue performance, form and opponent
        matchup analysis
      </p>
      ...
      {results && (
        <div className="fade-in">
          ...
          <div className="alert alert-info" style={{ marginBottom: "1.5rem" }}>
            <strong>
              Active Player Pool: {results.active_player_pool_size} players
            </strong>
            {" · "}
          ...
          {activeTab === "xi" && (
            <div className="fade-in">
              ...
              <div className="grid-4" style={{ marginBottom: "1.5rem" }}>
                {[
                  {
                    v: results.xi_balance?.left_hand_batters,
                    l: "Left-Handers",
                  },
                  {
                    v: results.xi_balance?.right_hand_batters,
                    l: "Right-Handers",
                  },
                  ...
                  <div key={i} className="player-card">
                    ...
                    <div className="player-info">
                      ...
                      <div className="player-role">
                        <span
                          style={{ color: ROLE_COLORS[p.role] || "#94a3b8" }}
                        >
                          {p.role}
                        </span>
                        {" · "}
          ...
          {activeTab === "squad" && (
            <div className="fade-in card">
              <div className="card-title">📋 Full Squad — Ranked by Score</div>
              ...
              <div className="grid-2" style={{ marginBottom: "1.5rem" }}>
                <div className="card">
                  ...
                  <div style={{ marginBottom: "1rem" }}>
                    ...
                    {Object.entries(
                      results.opponent_analysis?.bowler_types || {},
                    ).map(([k, v]) => (
                      <div
                        key={k}
                        style={{
                  ...
                  <div>
                    ...
                    {Object.entries(
                      results.opponent_analysis?.batter_types || {},
                    ).map(([k, v]) => (
                      <div
                        key={k}
                        style={{
