          ...
          <>
            ...
            <div style={s.chartsRow}>
              ...
              <div style={s.chartCard}>
                ...
                <p style={s.chartSub}>
                  Economy rate comparison (lower is better)
                </p>
                {bowlerData.length > 0 ? (
                  <ResponsiveContainer width="100%" height={280}>
                    <BarChart
            ...
            <div style={s.chartsRow}>
              <PlayerTable
                title="Top Batters"
                players={report.team1_top_batters || []}
                type="batting"
              />
              <PlayerTable
                title="Top Bowlers"
                players={report.team1_top_bowlers || []}
                type="bowling"
              />
            </div>
            ...
            <div style={s.reportFooter}>
              <p>
                Report generated for <strong>{venue}</strong> — {team1} vs{" "}
                {team2}
              </p>
              <p
                style={{
              ...
              >
                Based on historical T20I data from Cricsheet · ©{" "}
...
function SummaryCard({ icon, label, value, sub, highlight }) {
  return (
    <div
      style={{ ...s.summaryCard, ...(highlight ? s.summaryCardHighlight : {}) }}
    >
          ...
          {players.slice(0, 6).map((p, i) => (
            <tr key={i} style={s.tr}>
              ...
              {type === "batting" ? (
                <>
                  <td
                    style={{ ...s.td, textAlign: "center", color: "#f59e0b" }}
                  >
                    {p.runs}
                  </td>
